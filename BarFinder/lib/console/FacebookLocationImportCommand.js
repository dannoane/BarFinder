...
var FacebookLocation = require('./../import/FacebookLocation').FacebookLocation;

program
  .version('1.0.0')
  .option('-c, --city <name>', 'City from which to import locations')
  .parse(process.argv);
...
cityPromise.then(function (city) {
  ...
  platformPromise.then(function (platform) {
    ...
    var facebookLocation = new FacebookLocation(city, platform.accessToken);
    facebookLocation.import();
  });
});
